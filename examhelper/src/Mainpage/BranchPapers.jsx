...
const papers = {
  csm: [
    ...
    { title: '2-2 Mid 1 Papers', file: '/files/csm2-2mid1.pdf' },
     ...
     {title:'2-2  sem Papers',file:'/files/csm2-2sem.pdf'},
     {title:'3-1  sem Papers',file:'/files/csm3-1sem.pdf'},
      {title:'3-1  Mid 2 Papers',file:'/files/csm3-1mid2.pdf'}
    
  ],
  cai: [
    { title: '2-1 Mid 1 Papers', file: '/files/csmmid1.pdf' },
    { title: '2-1 Mid 2 Papers', file: '/files/csmmid2.pdf' },
    { title: '2-1 SEM Papers', file: '/files/csmsem.pdf' },
    { title: '2-2 Mid 1 Papers', file: '/files/csm2-2mid1.pdf' },
    { title: '2-2 Mid 2 Papers', file: '/files/csm2-2mid2.pdf' },
      {title:'2-2  sem Papers',file:'/files/csm2-2sem.pdf'},
